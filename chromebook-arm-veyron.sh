...
base="kali-menu kali-defaults alsa-utils e2fsprogs initramfs-tools kali-defaults kali-menu parted pulseaudio sudo usbutils firmware-linux firmware-atheros firmware-libertas firmware-realtek"
