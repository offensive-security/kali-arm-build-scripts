...
base="apt-utils kali-defaults alsa-utils e2fsprogs ifupdown initramfs-tools kali-defaults kali-menu parted pulseaudio sudo usbutils firmware-linux firmware-atheros firmware-libertas firmware-realtek"
