...
git clone --depth 1 https://github.com/hardkernel/linux -b odroidw-3.12.y ${basedir}/root/usr/src/kernel
...
cp ${basedir}/../kernel-configs/odroid-w.config ../odroid-w.config
