...
base="kali-menu kali-defaults alsa-utils e2fsprogs initramfs-tools kali-defaults kali-menu laptop-mode-tools parted sudo usbutils firmware-linux firmware-atheros firmware-libertas firmware-realtek"
