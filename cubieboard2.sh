...
# soon.
echo "Generating sha256sum of kali-$1-cubieboard2.img"
sha256sum kali-$1-cubieboard2.img > ${basedir}/kali-$1-cubieboard2.img.sha256sum
...
echo "Generating sha256sum of kali-$1-cubieboard2.img.xz"
sha256sum kali-$1-cubieboard2.img.xz > ${basedir}/kali-$1-cubieboard2.img.xz.sha256sum
fi
