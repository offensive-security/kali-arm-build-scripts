...
dd if=/dev/zero of=${basedir}/kali-linux-$1-rpi.img bs=1M count=$size
parted kali-linux-$1-rpi.img --script -- mklabel msdos
parted kali-linux-$1-rpi.img --script -- mkpart primary fat32 0 64
parted kali-linux-$1-rpi.img --script -- mkpart primary ext4 64 -1

# Set the partition variables
loopdevice=`losetup -f --show ${basedir}/kali-linux-$1-rpi.img`
...
# soon.
echo "Generating sha256sum for kali-linux-$1-rpi.img"
sha256sum kali-linux-$1-rpi.img > ${basedir}/kali-linux-$1-rpi.img.sha256sum
# Don't pixz on 32bit, there isn't enough memory to compress the images.
MACHINE_TYPE=`uname -m`
if [ ${MACHINE_TYPE} == 'x86_64' ]; then
echo "Compressing kali-linux-$1-rpi.img"
pixz ${basedir}/kali-linux-$1-rpi.img ${basedir}/kali-linux-$1-rpi.img.xz
rm ${basedir}/kali-linux-$1-rpi.img
echo "Generating sha256sum for kali-linux-$1-rpi.img.xz"
sha256sum kali-linux-$1-rpi.img.xz > ${basedir}/kali-linux-$1-rpi.img.xz.sha256sum
fi
