...
wget 'http://ftp.us.debian.org/debian/pool/main/f/firefox-esr/firefox-esr_60.3.0esr-1_arm64.deb' -O "${basedir}"/kali-${architecture}/root/firefox-esr_60.3.0esr-1_arm64.deb
...
apt install --yes --allow-change-held-packages /root/firefox-esr_60.3.0esr-1_arm64.deb
