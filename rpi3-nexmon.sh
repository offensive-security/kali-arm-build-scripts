...
# Size of image in megabytes (Default is 4000=4.0GB)
size=4000
# Suite to use.  
# Valid options are:
...
base="apt-utils console-setup kali-defaults e2fsprogs ifupdown initramfs-tools parted sudo usbutils firmware-linux firmware-realtek firmware-atheros firmware-libertas firmware-brcm80211 net-tools iw wget psmsic"
